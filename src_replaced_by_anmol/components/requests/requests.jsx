        ...
        >
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2, lineHeight: 1.5 }}>
               {row.village_data[0].display_name} (Pin: {row.village_data[0].pin_code})<br />
  ...
  return (
    <>
      ...
      >
        ...
        <TableCell>
          <Tooltip title={`Village: ${row.village_data[0].display_name} (Pin: ${row.village_data[0].pin_code}), Mobile: ${row.form_data[0].mobileNumber}`} arrow>
            <Typography 
              variant="body2" 
              sx={{ 
                maxWidth: 300,
            ...
            >
              Village: {row.village_data[0].display_name} (Pin: {row.village_data[0].pin_code})
            </Typography>
          </Tooltip>
        </TableCell>
        <TableCell>
