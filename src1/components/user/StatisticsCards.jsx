...
import { Container, Grid, Card, CardContent, Typography, Box, Chip, Icon } from '@mui/material';
      ...
      >
        {statisticsData.map((stat, index) => (
          ...
          >
            ...
            >
              <Link
                to={stat.link || `/details/${index}`} // Fallback to a default path if stat.link is not provided
